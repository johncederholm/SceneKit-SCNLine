...
public extension simd_quatf {
    ...
    public static func zero() -> simd_quatf {
    ...
    static func getAllLineParts(
        ...
        for (index, point) in points.enumerated() {
            ...
            if index == 0 {
                ...
                let v = trueVs[(trueVs.count - edges * 2)...]
                let u = Array(v)
                
                trueVs.append(contentsOf: u)
                ...
                if point.distance(vector: points[index - 1]) > radius * 2 {
                    ...
                    if mTurn > 1 {
                        ...
                        for i in 0..<Int(mTurn) {
                            ...
                            SCNGeometry.addCylinderVerts(to: &trueInds,
                                                         startingAt: trueVs.count - edges * 4,
                                                         edges: edges)
